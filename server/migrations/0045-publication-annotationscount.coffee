class Migration extends Document.MinorMigration
  name: "Adding a generator for number of annotations in a publication"
  ...
  backward: (db, collectionName, currentSchema, oldSchema, callback) =>
    db.collection collectionName, (error, collection) =>
      ...
      collection.update {_schema: currentSchema}, {$unset: {'annotationsCount': ''}}, {multi: true}, (error, count) =>
        return callback error if error
